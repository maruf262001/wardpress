  ...
  <div class="row hero">
      ...
      <div class="col-lg-4 hero_side">
        ...
        <div class="side_video">
          ...
          <a href=""><img src="<?=get_template_directory_uri()?>./assets/images/sidebar/mask-bd-portal (1).jpg"class="d-block w-100 h-50"  alt=""></a>
          <h6>ডেঙ্গু প্রতিরোধে করণীয়</h6>
          <a href=""><img src="<?=get_template_directory_uri()?>./assets/images/sidebar/dengu.jpg" class="d-block w-100 h-50" alt=""></a>
  ...
  <div class="row footer_bottom">
    ...
    <div class="col-lg-4 fb_right">
      <p>
        ...
        পরিকল্পনা ও বাস্তবায়নে: <a href="">এটুআই,</a><a href="">মন্ত্রিপরিষদ বিভাগ, </a><a href="">বিসিসি,</a> <a href=""> বেসিস,</a><a href=""> ডিওআইসিটি</a>
      </p>
